...
// 进度更新函数：命名导出
export function updateProgress(step: string, current: number, total = 0, detail = null) {
...
// 重置任务函数：命名导出
export function resetTask(date: number) {
  currentTask = {
...
// 设置任务状态函数：命名导出
export function setTaskStatus(status: string, error = null) {
