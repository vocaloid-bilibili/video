// packages/remotion-engine/src/components/OverallPoint.tsx
...
export function OverallPoint({
  ...
  const hasBefore = !isNewSong && point_before && point_before !== "-";
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        {isNewSong ? (
          ...
          (() => {
            ...
            const rate = before > 0 ? ((diff / before) * 100).toFixed(1) : "0";
            const isUp = diff >= 0;
